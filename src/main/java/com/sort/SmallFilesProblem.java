 ...
 */
public class SmallFilesProblem extends Configured implements Tool {
	...
	public static class WordOffset implements WritableComparable<WordOffset> {
		...
		public int compareTo(WordOffset o) {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SmallFilesProblem.class);
	...
	public static void main(String[] args) throws Exception {
		int ret = ToolRunner.run(new SmallFilesProblem(), args);
		System.exit(ret);
	}
